...
import com.quarkonium.qpocket.abi.datatypes.Array;
 ...
 */
public abstract class TypeReference<T extends com.quarkonium.qpocket.abi.datatypes.Type>
    ...
    public static <T extends com.quarkonium.qpocket.abi.datatypes.Type> TypeReference<T> create(
            final Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.quarkonium.qpocket.abi.datatypes.Type>
