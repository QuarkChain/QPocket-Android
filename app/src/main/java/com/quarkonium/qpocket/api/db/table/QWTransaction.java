...
public class QWTransaction implements Parcelable {

    public static final Parcelable.Creator<QWTransaction> CREATOR = new Parcelable.Creator<QWTransaction>() {
        @Override
        public QWTransaction createFromParcel(Parcel in) {
            return new QWTransaction(in);
        }

        @Override
        public QWTransaction[] newArray(int size) {
            return new QWTransaction[size];
        }
    };
    ...
    public QWTransaction() {
    }

    private QWTransaction(Parcel in) {
        id = in.readInt();
    ...
    public QWTransaction(String txId, String amount, String from, String to, String block, String timestamp, String status, String cost, String direction) {
        this.txId = txId;
        this.amount = amount;
        this.from = from;
        this.to = to;
