...
import com.quarkonium.qpocket.crypto.utils.ByteUtil;
import com.quarkonium.qpocket.tron.keystore.ECKeyFactory;
import com.quarkonium.qpocket.tron.utils.BIUtil;
...
public class ECKey implements Serializable {
    ...
    public static class ECDSASignature {
        ...
        public byte[] toDefaultByteArray() {
            return ByteUtil.merge(
                    ByteUtil.bigIntegerToBytes(this.r, 32),
                    ByteUtil.bigIntegerToBytes(this.s, 32),
                    new byte[]{this.v});
