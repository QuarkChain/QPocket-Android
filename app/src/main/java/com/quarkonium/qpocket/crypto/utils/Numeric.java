package com.quarkonium.qpocket.crypto.utils;


import android.text.TextUtils;

import com.quarkonium.qpocket.MainApplication;
import com.quarkonium.qpocket.abi.datatypes.generated.Int32;
import com.quarkonium.qpocket.abi.datatypes.generated.Uint32;
import com.quarkonium.qpocket.crypto.exceptions.MessageDecodingException;
import com.quarkonium.qpocket.crypto.exceptions.MessageEncodingException;
...
public final class Numeric {
    ...
    //eth地址转为QUARK地址
    public static String parseAddressToQuark(String address) {
        ...
        String totalSize = SharedPreferencesUtils.getTotalChainCount(MainApplication.getContext());
    ...
    public static String selectChainAndShardAddress(String address, String chainId, String shardId) {
        long chain = Numeric.toBigInt(chainId).longValue();
        long shard = Numeric.toBigInt(shardId).longValue();
        return selectChainAndShardAddress(address, chain, shard);
    }

    public static String selectChainAndShardAddress(String address, long chain, long shard) {
        BigInteger totalShard = BigInteger.ONE;
        List<String> allShared = SharedPreferencesUtils.getTotalSharedSizes(MainApplication.getContext());
