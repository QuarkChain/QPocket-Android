...
public class SignedRawTransaction extends RawTransaction {
    ...
    public SignedRawTransaction(BigInteger nonce, BigInteger gasPrice,
                                ...
                                String data,
                                BigInteger fromShard, BigInteger toShard, BigInteger networkId,
                                Sign.SignatureData signatureData,
                                BigInteger transferToken, BigInteger gasToken) {
        super(nonce, gasPrice, gasLimit, to, value, data, fromShard, toShard, networkId, transferToken, gasToken);
