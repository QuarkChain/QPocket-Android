...
public class Wallet {
    ...
    //解密keystore 生成私钥
    private static ECKeyPair decrypt(String password, WalletFile.Crypto crypto) throws CipherException {
    ...
    public static ECKeyPair decrypt(String password, String keyStore) throws CipherException {
