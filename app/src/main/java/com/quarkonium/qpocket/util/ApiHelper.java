...
public class ApiHelper {
     ...
     * Version >= 8
     */
    public static final boolean AFTER_FROYO = Build.VERSION.SDK_INT >= VERSION_CODES.FROYO;

    /**
     * Version >= 9
     */
    public static final boolean AFTER_GINGERBREAD = Build.VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD;

    /**
     * Version >= 10
     */
    public static final boolean AFTER_GINGERBREAD_MR1 = Build.VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD_MR1;

    /**
     * Version >= 11
     */
    public static final boolean AFTER_HONEYCOMB = Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB;

    /**
     * Version >= 12
     */
    public static final boolean AFTER_HONEYCOMB_MR1 = Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB_MR1;

    /**
     * Version >= 13
     */
    public static final boolean AFTER_HONEYCOMB_MR2 = Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB_MR2;

    /**
     * Version >= 14
     */
    public static final boolean AFTER_ICE_CREAM_SANDWICH = Build.VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH;

    /**
     * Version >= 15
     */
    public static final boolean AFTER_ICE_CREAM_SANDWICH_MR1 = Build.VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH_MR1;

    /**
     * Version >= 16
     */
    public static final boolean AFTER_JELLY_BEAN = Build.VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN;

    /**
     * Version >= 17
     */
    public static final boolean AFTER_JELLY_BEAN_MR1 = Build.VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1;

    /**
     * Version >= 18
     */
    public static final boolean AFTER_JELLY_BEAN_MR2 = Build.VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR2;

    /**
     * Version >= 19
     */
    public static final boolean AFTER_KITKAT = Build.VERSION.SDK_INT >= VERSION_CODES.KITKAT;

    /**
     * Version >= 19
     */
    public static final boolean AFTER_LOLLIPOP = Build.VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP;

    /**
     * Version >= 23
     */
    public static final boolean AFTER_MARSHMALLOW = Build.VERSION.SDK_INT >= VERSION_CODES.MARSHMALLOW;

    /**
     * Version >= 24
     */
    public static final boolean AFTER_NOUGAT = Build.VERSION.SDK_INT >= VERSION_CODES.NOUGAT;
    ...
    public static final boolean USE_API_14_START_UP =
            Build.VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH;
    ...
    public static final boolean HAS_MEDIA_COLUMNS_WIDTH_AND_HEIGHT =
            hasField(MediaStore.MediaColumns.class, "WIDTH");
    ...
    static {
        ...
        boolean isARM = true;
        try {
            final String cupABI2 = Build.CPU_ABI2.toLowerCase();
            isARM = !("x86.".equals(cupABI2) || "mips".equals(cupABI2));
        } catch (Throwable t) {
            isARM = true;
        }
        IS_ARM = isARM;
