...
package com.quarkonium.qpocket.bip32;
...
import static com.quarkonium.qpocket.bip32.ByteArrayWriter.head32;
import static com.quarkonium.qpocket.bip32.ByteArrayWriter.tail32;
import static com.quarkonium.qpocket.bip32.HmacSha512.hmacSha512;
import static com.quarkonium.qpocket.bip32.Secp256k1SC.gMultiplyAndAddPoint;
import static com.quarkonium.qpocket.bip32.Secp256k1SC.n;
import static com.quarkonium.qpocket.bip32.Secp256k1SC.pointSerP;
...
public final class ExtendedPublicKey implements
    ...
    public ExtendedPublicKey cKDpub(final int index) {
        ...
        final BigInteger parse256_Il = BigIntegerUtils.parse256(Il);
