...
import com.quarkonium.qpocket.view.listener.WheelItem;
...
public class WheelView extends View {
    ...
    public final void setTextSize(int size) {
        if (size > 0.0F) {
            textSize = (int) (getContext().getResources().getDimension(size));
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = (int) UiUtils.dpToPixel(textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = (int) UiUtils.dpToPixel(ITEM_PADDING);
            }
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = (int) UiUtils.dpToPixel(8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = (int) UiUtils.dpToPixel(8);
                break;
            case Gravity.RIGHT:
