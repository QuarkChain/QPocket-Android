...
public class QuarkThreeButtonDialog extends Dialog {

    private Drawable mPositiveBtnDrawable;
    private Drawable mNegativeBtnDrawable;
    private String mPositiveBtnText;
    private String mPositiveBtn2Text;
    ...
    private View.OnClickListener mPositiveBtn2ClickListener;
    ...
    public QuarkThreeButtonDialog(Context context) {
        super(context, R.style.CompositeSDKFullScreenDialog);
    }

    public QuarkThreeButtonDialog(Context context, boolean canceledOnTouchOutside) {
        super(context, R.style.CompositeSDKFullScreenDialog);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView positiveBtn2 = findViewById(R.id.positive_btn2);
        if (null != mPositiveBtnDrawable) {
            positiveBtn2.setBackgroundDrawable(mPositiveBtnDrawable);
        }
        if (null != mPositiveBtn2Text) {
            positiveBtn2.setText(mPositiveBtn2Text);
        } else {
            positiveBtn2.setVisibility(View.GONE);
        }
        if (null != mPositiveBtn2ClickListener) {
            positiveBtn2.setOnClickListener(mPositiveBtn2ClickListener);
        }
        ...
        mInfoView = findViewById(R.id.dialog_info);
        if (!TextUtils.isEmpty(mInfoText)) {
            Paint paint = mInfoView.getPaint();
            Rect rect = new Rect();
            paint.getTextBounds("海报", 0, 1, rect);
            float height = rect.height() * 4.5f;
            mInfoView.setMaxHeight(Math.round(height));
    ...
    public void setPositiveBtn2(String text, View.OnClickListener listener) {
        setPositiveBtn2(null,
                text,
                listener);
    }

    public void setPositiveBtn2(int text, View.OnClickListener listener) {
        setPositiveBtn2(null,
                text,
                listener);
    }

    public void setPositiveBtn2(int drawable, int text, View.OnClickListener listener) {
        Resources resources = getContext().getResources();
        setPositiveBtn2(drawable == 0 ? null : resources.getDrawable(drawable),
                text == 0 ? "" : resources.getString(text),
                listener);
    }

    public void setPositiveBtn2(Drawable drawable, int text, View.OnClickListener listener) {
        Resources resources = getContext().getResources();
        setPositiveBtn2(drawable,
                text == 0 ? "" : resources.getString(text),
                listener);
    }

    public void setPositiveBtn2(int drawable, String text, View.OnClickListener listener) {
        Resources resources = getContext().getResources();
        setPositiveBtn2(drawable == 0 ? null : resources.getDrawable(drawable),
                text,
                listener);
    ...
    public void setPositiveBtn2(Drawable drawable, String text, View.OnClickListener listener) {
        mPositiveBtnDrawable = drawable;
        mPositiveBtn2Text = text;
        mPositiveBtn2ClickListener = listener;
    }
